...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("RulesObjectPageObjectPage journey");

        opaTest("Navigate to RulesObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            When.onTheRulesListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheRulesListGenerated.onTable().iCheckRows();
            When.onTheRulesListGenerated.onTable().iPressRow(0);
