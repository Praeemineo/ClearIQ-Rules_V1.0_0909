...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheConfigurationListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheConfigurationListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheConfigurationListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheConfigurationListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheConfigurationListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheConfigurationListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheConfigurationListGenerated.onTable(defaultTableId).iPressRow(0);
